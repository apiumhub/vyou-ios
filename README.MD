...
All these steps are needed to ensure all the security steps related with OAuth protocol. After register password successfully, the user can use the [sign in](#sign-in) method to log into the platform.
